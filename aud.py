        ...
        if response.status_code == 200:
            ...
            if sid_value:
                ...
                voice_params = {
                    ...
                    "voice": udB.get_key("voice"),  # Default to voice4 or replace with desired value
                    "duplex": "false",
                    "mode": "eager"
                }
                voice_headers = {
                ...
                voice_response = requests.get(voice_url, headers=voice_headers, params=voice_params)
                ...
                if voice_response.status_code == 200:
                    ...
                    await response_message.edit("`Error: Failed to generate audio file.`")
            else:
                await response_message.edit("`Error: 'sid' value not found in the response.`")
        else:
            await response_message.edit("`Error: Failed to get response from the first request.`")
